...
//start 
$sub= $_SESSION['sub'];
$quere4="select name from subject where  id='$sub' ";
$result2=mysqli_query($conn,$quere4);
   ...
   <?php 
     ...
     ?>"  class="form-control border" id="exampleInputdate"  required="required">
      ...
      <div class="modal-footer">
        ...
        <center><h6 style="color:#000;"><mark style="background:#fff;">Name:<?php 
      ...
      <!-- code to fetch no of present of student ends -->
                    ...
                    <br>
                                ...
                                $s=1;
                                            ...
                                            and Reg_no='$rollno'and Date between '$date1' and  '$date2' and batch='$batch'
