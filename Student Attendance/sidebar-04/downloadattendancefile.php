...
<div class="d-flex align-items-stretch" style="background-image: url(back15.jpg);background-repeat:no-repeat;background-size:cover;">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="#"><span class="fa fa-download mr-3"></span>Download attendance File</a>
                </li>
...
<form action ="excel.php" method="POST">
    ...
    <select  id="sel_depart" name="sem" class="form-control"    required>
    ...
    <?php 
        ...
        <div class="clear"></div>
            ...
            <select   id="sel_user" class="form-control"  name="sub"  required>
     ...
     ?>" class="form-control border" id="exampleInputdate" name="date2" required>
                ...
                <button type="submit" id="btSubmit" name="login" class="btn btn-danger" >Download CSV</button>
