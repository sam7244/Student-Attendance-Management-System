 ...
 $flag=0;
 	...
 	if (isset($_POST['login'])) {
		...
		$password = mysqli_real_escape_string($conn, $_POST['password']);
			...
			$query = "select management_email,password FROM management WHERE management_email='$useremail' AND password='$password'";
			...
			if (mysqli_num_rows($results) == 1) {
				$_SESSION['email']=$useremail;
					header('location:../../managementaddstudent.php');
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('back4.jpg');">
    ...
    <span aria-hidden="true">&times;</span>
		...
		<?php }  ?>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Useremail is reauired">
						<span class="label-input100">Mangament Email</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" type="password" name="password" id="password-field" id="txt"  placeholder="Type your password">
