...
<div class="d-flex align-items-stretch" style="background-image: url(back11.jpg);background-repeat:no-repeat;background-size:cover;">
        ...
        <center><b><h1 class="h3" style="color:orange">APP AND SOFTWARE DEVELOPMENT</h1></b></center>
        <div class="card-deck">
  <div class="card">
    <img src="p11.jpeg" style="height:330px;" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title text-center"><b>Sammed Jain </b></h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title text-center"><b>Shivaraj B G</b></h5>
      <p class="card-title text-dark"><b>Designation : Assistant Professor</b></p>
      <p class="card-title text-dark"><b>Department : App and Software Development</b></p>
