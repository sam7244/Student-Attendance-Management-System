...
{
	$id=intval($_GET['del']);
	$adn="delete from faculty where id='$id'";
...
<a href="removefaculty.php?del=<?php echo $row->id;?>" title="Delete Record" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
