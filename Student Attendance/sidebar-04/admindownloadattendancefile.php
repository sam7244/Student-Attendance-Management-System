...
<div class="form-group">
                    ...
                    <!-- <input type="text" id="browser" name="co" list="course" placeholder="  Select Your course" class="col-lg-12 col-sm-12 col-12 p-2" style="outline:none;border:none;text-indent:5px;" required>
                       ...
                       <?php $r="select * from course";
                                ...
                                echo " <input type='search' id='name' name='course' list='course' placeholder='  Select Your course' class='col-lg-12 col-sm-12 col-12 p-2' style='outline:none;border:none;text-indent:5px;' required>";
                ...
                <div class="form-group">
                    ...
                    <?php $r="select * from faculty";
                                $result=mysqli_query($con,$r);
                                echo " <input type='search'  name='fname' list='co' placeholder='  Select Faculty name' class='col-lg-12 col-sm-12 col-12 p-2' style='outline:none;border:none;text-indent:5px;' required>";
                                echo "<datalist id='co'>";
